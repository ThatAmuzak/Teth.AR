...
{
    /// <summary>
    /// Component to allow hot-swapping of colors on a MeshRenderer's material at
    /// runtime or in editor. It uses a MaterialPropertyBlock to avoid creating new
    /// material instances.
    /// </summary>
    public class HotSwapColor : MonoBehaviour
    {
        ...
        public Color AppliedColor => color;
        ...
        /// <summary>
        /// Called when the object becomes enabled and active. Applies the current
        /// color.
        /// </summary>
        private void OnEnable() { ApplyColor(); }

        /// <summary>
        /// Called in the editor when the script is loaded or a value is changed in
        /// the inspector. Applies the current color for immediate visual feedback.
        /// </summary>
        ...
        /// <summary>
        /// Applies the currently set color to the MeshRenderer using a
